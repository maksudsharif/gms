...
angular.module('award').controller('Award.TasksController', ['$scope', '$state', '$stateParams', '$q', '$translate'
    , 'UtilService', 'ConfigService', 'Helper.UiGridService', 'ObjectService', 'Object.TaskService', 'Task.WorkflowService', 'Case.InfoService', 'Helper.ObjectBrowserService'
    , function ($scope, $state, $stateParams, $q, $translate, Util, ConfigService, HelperUiGridService, ObjectService, ObjectTaskService, TaskWorkflowService, CaseInfoService, HelperObjectBrowserService) {
