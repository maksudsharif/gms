 ...
 * 
 */
package com.arkcase.gms.web.api;
...
public class GetCostsheetsForUserAPIController {
	...
	public String getCostsheetsForUser(@PathVariable("userId") String userId, 
            ...
            @RequestParam(value = "s", required = false, defaultValue = "") String sort,
		   	@RequestParam(value="objectSubType", required = false, defaultValue="") String objectSubType,
            Authentication auth) throws AcmListObjectsFailedException
	{
		...
		String jsonResponse = getCostsheetService().getObjectsWithSubTypesFromSolr(CostsheetConstants.OBJECT_TYPE, objectSubType, auth, startRow, maxRows, sort, userId);
