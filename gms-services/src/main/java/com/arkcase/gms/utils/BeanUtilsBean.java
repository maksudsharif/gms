...
public class BeanUtilsBean extends org.apache.commons.beanutils.BeanUtilsBean
{
    ...
    /**
     * This method overriding the superclass method. Skip "null" values and goes recursively if the field is non-primitive
     * and non-wrapped type.
     *
